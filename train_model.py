...
if __name__ == '__main__':
    ...
    parser.add_argument('--attack', default=0,metavar = 'attack',type=int,help='0 for FGSM 1 for MIFGSM 2 for PGD 3 for DF')
    ...
    parser.add_argument('--step_size', default=7, metavar='step_size', type=int, help='Epsilon') ## attack iteration
    ...
    if mode == 0:
        ...
        adv_loader = generatePGD(test_loader_2,model1,device,eps,max_itr,criterion)
